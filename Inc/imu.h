...
extern uint8_t imu_data[10];
extern uint8_t imu_cmd[10];
...
float GyroRate1(float angle,float time);
float ExpectRate1(float angle,float time);
float GyroRate2(float angle,float time);
float ExpectRate2(float angle,float time);
float GyroRate3(float angle,float time);
float ExpectRate3(float angle,float time);
