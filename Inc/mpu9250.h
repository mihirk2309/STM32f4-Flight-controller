...
#define MPU9250_RA_MAG_WHO_AM_I	0x00		// should return 0x48
...
#define MPU9250_RA_MAG_ST2      0x09		//// Data overflow bit 3 and data read error status bit 2
#define MPU9250_RA_MAG_CNTL      0x0A  // Power down (0000), single-measurement (0001), self-test (1000) and Fuse ROM (1111) modes on bits 3:0
#define MPU9250_RA_MAG_ASTC      0x0C  // Self test control
#define MPU9250_RA_MAG_I2CDIS    0x0F  // I2C disable
#define MPU9250_RA_MAG_ASAX      0x10  // Fuse ROM x-axis sensitivity adjustment value
#define MPU9250_RA_MAG_ASAY      0x11  // Fuse ROM y-axis sensitivity adjustment value
#define MPU9250_RA_MAG_ASAZ      0x12  // Fuse ROM z-axis sensitivity adjustment value


#define MPU9250_ADDRESS     		0xD0 
// address pin low (GND), default for InvenSense evaluation board, 0x68 shift left by 1 bit     
